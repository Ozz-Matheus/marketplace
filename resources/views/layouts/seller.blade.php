            ...
            <div class="row">
                <div class="col-3">
                    <div class="list-group">
                        <a href="/seller" class="list-group-item list-group-item-action active">Inicio</a>
                        <a href=" {{route('seller.orders.index')}} " class="list-group-item list-group-item-action">Ordenes</a>
                        <a href=" {{url('/admin/shops')}} " class="list-group-item list-group-item-action">Ir a la tienda</a>
                    </div>
                </div>
                <div class="col-9">
                    @yield('content')
